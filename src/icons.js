import { createElement, Terminal, SquareTerminal, Plus, Minus, Square, X, Search, Settings2, BookmarkPlus, Bookmark, Layers, FolderSync, Folder, FolderOpen, File, FileCode2, FileJson, FileText, FileImage, FileArchive, FilePenLine, FolderUp, FolderPlus, Folders, Monitor, Upload, Download, ArrowUp, ArrowDown, CornerDownLeft, RefreshCw, RotateCw, Save, Eraser, Columns2, PanelRight, PanelLeft, Server, ServerCog, MoreHorizontal, Pencil, Pin, PinOff, Trash2, ExternalLink, KeyRound, Sparkles, History, ChevronDown, ChevronsRight, Braces, Globe, HardDrive, Cpu, MemoryStick, Timer, Link2 } from 'lucide';
const nodes={Terminal,SquareTerminal,Plus,Minus,Square,X,Search,Settings2,BookmarkPlus,Bookmark,Layers,FolderSync,Folder,FolderOpen,File,FileCode2,FileJson,FileText,FileImage,FileArchive,FilePenLine,FolderUp,FolderPlus,Folders,Monitor,Upload,Download,ArrowUp,ArrowDown,CornerDownLeft,RefreshCw,RotateCw,Save,Eraser,Columns2,PanelRight,PanelLeft,Server,ServerCog,MoreHorizontal,Pencil,Pin,PinOff,Trash2,ExternalLink,KeyRound,Sparkles,History,ChevronDown,ChevronsRight,Braces,Globe,HardDrive,Cpu,MemoryStick,Timer,Link2};
const cache=new Map();
